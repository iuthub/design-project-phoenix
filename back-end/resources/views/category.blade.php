    ...
    <div class="card border-primary">
        <div class="card-body text-primary">
          ...
          {{-- <input type="hidden" name="id" id="first_id" value="{{$category->cat_id}}"> --}}
           ...
           <a href="{{ route('menus.edit_first' ,[ 'id' => $category->cat_id]) }} "><button type="button" class="btn  btn-outline-primary col-md-4  mr-4" data-toggle="modal" id="edit_modal" data-target="#myModal">Edit</button></a>
